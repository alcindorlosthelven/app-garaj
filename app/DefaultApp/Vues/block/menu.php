...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <!--    <img src="<?/*= \app\DefaultApp\Models\Configuration::getValueOfConfiguraton("logo"); */?>" alt="" class="brand-image elevation-3"
             style="opacity: .8">-->
        <span class="brand-text font-weight-light">APP-GARAJ</span>
    </a>
    ...
    <div class="sidebar">
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-item">
                    <a href="<?= App::genererUrl("stock") ?>" class="nav-link">
               ...
               <!-- <li class="nav-item">
                    <a href="<?/*= App::genererUrl("depense") */?>" class="nav-link">
                        <i class="nav-icon fa fa-shopping-bag
