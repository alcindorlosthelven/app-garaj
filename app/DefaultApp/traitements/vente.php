    ...
    if($vente->getPayer()==="non") {
        ...
        if ($m == "ok") {
            ...
            foreach ($liste as $l) {
                ...
                \app\DefaultApp\Models\RepartitionStock::dimimuer($id_service, $l->getIdProduit(), $l->getQuantite(), \systeme\Model\Utilisateur::session_valeur(), "Vente");
