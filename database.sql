...
-- Dumping data for table app-garaj.entrer_sortie: ~16 rows (approximately)
...
-- Dumping data for table app-garaj.item_vente: ~9 rows (approximately)
...
-- Dumping data for table app-garaj.vente: ~5 rows (approximately)
