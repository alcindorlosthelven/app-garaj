...
class Utilisateur extends Model
{
    ...
    public function Enregistrer()
    {
        try {
            ...
            $con=self::connection();
            $req="insert into utilisateur(pseudo,email,role,nom,prenom,motdepasse,active,photo,telephone) value
            (:pseudo,:email,:role,:nom,:prenom,:motdepasse,:active,:photo,:telephone)";
